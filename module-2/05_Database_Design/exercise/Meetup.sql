...
VALUES
('Akomeah', 'Bismark', '614-218-7728', '1995-05-16','bismarkjunior@yahoo.com', 0),
('Webster', 'Annie', '440-787-6630', '1994-12-31', 'annie.webster@yahoo.com', 1),
('Akomeah', 'Anne', '440-878-3360', '1994-11-29', 'annie.akomeah@gmail.com', 0),
('Akomeah' , 'Linda', '614-556-7789', '1976-01-01', 'linda.akomeah@gmail.com', 1),
('Thomas' , 'John', '614-576-0094', '1974-04-15', 'john.thomas@gmail.com', 0),
('Matthews' , 'Chris', '614-588-4536', '1986-09-11', 'chris.matthews@gmail.com', 1),
('Thompson' , 'Louisa', '614-655-8575', '1996-08-12', 'louisa.thompson@gmail.com', 1),
('Fulton' , 'Marcus', '614-787-3245', '1926-05-18', 'marcus.fulton@gmail.com', 1)

INSERT INTO [member_group] (member_id, group_id)
VALUES (1,1), (2,2), (3,3), (4,4), (5,3), (6,2), (7,1)
 
INSERT INTO [member_interest_group] (member_id, group_id)
VALUES (1,1), (2,2), (3,3), (4,4), (5,4), (6,3), (7,2)
 
INSERT INTO event (event_name, event_description, start_time, event_length)
VALUES
('Music in the Park', 'Enjoy a relaxing evening of live music in the local park', '2023-10-20 18:00:00', 250 ),
('Tech Conference', 'A cutting-edge tech conference featuring keynote speakers and workshops.', '2023-11-05 09:00:00', 120),
('Art Exhibition Opening', 'Celebrate the opening of a new art exhibition showcasing local artists.', '2023-10-28 19:00:00', 120),
('Charity Run', 'Participate in a charity run to raise funds for a good cause', '2023-11-12 08:30:00', 240),
('Cooking Class', 'Learn to cook delicious dishes from a professional chef.', '2023-10-25 17:30:00', 150),
('Movie Night', 'Watch a classic film under the stars with friends and family.', '2023-11-03 19:00:00', 120),
('Book Club Meeting', 'Discuss the latest book selection and enjoy literary discussions.', '2023-10-22 16:00:00', 90)


INSERT INTO [Interest_Group] (group_name)
VALUES ('Family'),  ('Friends'),  ('Professional'), ('Personal')
