...
namespace USCitiesAndParks.DAO
{
    public class ParkSqlDao : IParkDao
    {
        ...
        public Park CreatePark(Park park)
        {
            ...
            string sqlCreatePark = "INSERT INTO park ( park_name, date_established, area, has_camping) " +
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sqlCreatePark, conn))
                    {
        ...
        public Park UpdatePark(Park park)
        {
            ...
            string sqlUpdatePark = "UPDATE park SET park_name = @park_name, date_established = @date_established, " +
                "area = @area, has_camping = @has_camping " +
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sqlUpdatePark, conn))
                    {
                        cmd.Parameters.AddWithValue("@park_name", park.ParkName);
                        cmd.Parameters.AddWithValue("@date_established", park.DateEstablished);
                        cmd.Parameters.AddWithValue("@area", park.Area);
