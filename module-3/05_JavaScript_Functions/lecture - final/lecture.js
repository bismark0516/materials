...
/**
 * 
 * Take the details of a person and create a human readable sentence
 * that uses that information to describe the person.  The quicks will
 * be joined together using the sparator or ', ' by default.
 * 
 * @param {string} name the name of the person being described 
 * @param {number} age the age the of person 
