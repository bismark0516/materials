...
export default {
  ...
  methods: {
    deleteBoard() {
      console.log("Reached deleteBoard in BoardView.vue")

      //todo - confirm user intent before doing this
      boardService.deleteBoard(this.board.id)
      .then( () => {
        console.log ("Reached then in deleteBoard of BoardView.vue")
        this.$router.push({ name: 'HomeView'});
      })
      .catch( () => {
        console.log ("Reached catch in deleteBoard of BoardView.vue")
      })
    }
  },
  created() {
