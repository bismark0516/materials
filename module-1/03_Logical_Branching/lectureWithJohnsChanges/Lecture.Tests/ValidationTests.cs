...
namespace Lecture.Tests
{
    ...
    public class ValidationTests
    {
        ...
        [TestMethod]
        public void Test_17_ReturnPizzaCost()
        {
            Assert.AreEqual(9.99M, exercises.ReturnPizzaCost('s', 1));
            Assert.AreEqual(10.99M, exercises.ReturnPizzaCost('m', 1));
            Assert.AreEqual(11.99M, exercises.ReturnPizzaCost('s', 3));
            Assert.AreEqual(10.99M, exercises.ReturnPizzaCost('l', 0));
            Assert.AreEqual(13.99M, exercises.ReturnPizzaCost('l', 4));
        }
    }
}
